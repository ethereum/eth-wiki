...
- [API](#api)
  ...
  - [Usage](#usage)
      ...
      - [web3.version.client](#web3versionclient)
      ...
      - [web3.toBigNumber](#web3tobignumber)
    ...
    - [web3.net](#web3net)
      ...
      - [web3.net.listening](#web3netlistening)
    ...
    - [web3.eth](#web3eth)
      ...
      - [web3.eth.defaultBlock](#web3ethdefaultblock)
      ...
      - [web3.eth.unRegister](#web3ethunregister)
      ...
      - [web3.eth.filter](#web3ethfilter)
        ...
        - [Watch callback return value](#watch-callback-return-value)
      ...
      - [web3.eth.getCompilers](#web3ethgetcompilers)
      ...
      - [web3.eth.compile.lll](#web3ethcompilelll)
      ...
      - [web3.eth.namereg](#web3ethnamereg)

        - [Usage](#usage-1)

    - [web3.db](#web3db)

      - [web3.db.putString](#web3dbputstring)
    ...
    - [web3.shh](#web3shh)
      ...
      - [web3.shh.newIdentity](#web3shhnewidentity)
      ...
      - [web3.shh.newGroup](#web3shhnewgroup)
      ...
      - [web3.shh.filter](#web3shhfilter)
        ...
        - [Callback return](#callback-return-1)
...
[RPC calls](http://wikijs.ethereum.wiki/JSON-RPC)を介して通信できます。
...
web3.js の洗練された使用例につきましては、[useful Ðapp patterns](http://wikijs.ethereum.wiki/Useful-Ðapp-Patterns)をごらんください。
...
1. `Object` - The transaction object to send:
  ...
  - `data`: `String` - (optional) Either a [byte string](http://wikijs.ethereum.wiki/Solidity,-Docs-and-ABI) containing the associated data of the message, or in the case of a contract-creation transaction, the initialisation code.
...
You can read more about events [here](http://wikijs.ethereum.wiki/Ethereum-Contract-ABI#example-javascript-usage).

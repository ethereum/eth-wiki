...
| **Elliptic curve** | [1108](https://eips.ethereum.org/EIPS/eip-1108) Reduce alt_bn128 precompile gas costs	| Benchmarks [incomplete](https://youtu.be/lF_XxqxgVuA?t=2896) 	| -	| Zachary Williamson to re-run benchmarks. Mariano Conti [is offering help if needed](https://twitter.com/nanexcool/status/1134583012748869634) 	|
...
| **Elliptic curve** | [2024 PR](https://github.com/ethereum/EIPs/pull/2024) Proposal for supporting Blake2b	| CD: [ZW / EVM1 opcode repricing/optimisation might be a precompile-free alternative](https://youtu.be/lF_XxqxgVuA?t=5054) Existing Golang implementation for [blake2b](https://github.com/golang/crypto/tree/master/blake2b) and [blake2s](https://github.com/golang/crypto/tree/master/blake2s)| -	| JP discuss with BM/CD/ZW whether optimisations will happen [soon enough](https://youtu.be/lF_XxqxgVuA?t=5347), especially as implementation is [trivial](https://youtu.be/lF_XxqxgVuA?t=5477) 	|
...
#### Key concepts:
- Dynamic jumps are problematic for contract analysis (control-flow, data-flow, static and formal) and are deprecated.
...
#### EIP interactions
- 615 requires one of the account versioning proposals to go ahead (1702, 1707/1217, 1891)
- 663 increases stack depth, which, if 615 goes ahead [will most likely be unecessary (as per Greg Colvin)](https://github.com/ethereum/EIPs/pull/663#issuecomment-318838695)  
...
- Is it true that 663 would provide no additional benefit if 615 goes ahead?
- Which account versioning proposal is most suitable?

#### Probable path forward
- Prepare for Istanbul: 615, one of the account versioning proposals
- Prepare for April 2020 Hard Fork: None
- Shelve indefinitely: 663, two of the account versioning proposals

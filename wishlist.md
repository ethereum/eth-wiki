...
A possible solution is to switch to a binary trie. See an implementation [here](https://github.com/ethereum/research/tree/master/trie_research), as well as [sharding account redesign](http://wikijs.ethereum.wiki/Wishlist#parallelization) below.
...
* Sharding account redesign: https://github.com/ethereum/sharding/blob/7610bf66f18529d0bc86e824420e1ad7c0a44d4b/docs/doc.md#two-layer-trie-redesign. This also relates to [tries as above](http://wikijs.ethereum.wiki/Wishlist#trie).

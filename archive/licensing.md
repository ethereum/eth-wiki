...
The middleware of Ethereum, including the Javascript-based web3.js, the web3 libraries and eth (the command line client) will be distributed under the LGPL license. We wish to allow free development of technologies by allowing linking to arbitrary software, but again would like to incentivise feeding of back-end integration work back into the community, especially regarding the interoperability with legacy systems.
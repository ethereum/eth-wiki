...
Note: it is planned for RLP to be **replaced** by a more preferable form of serialization, as outlined [here](https://ethresear.ch/t/blob-serialisation/1705), and implemented by [sharding clients](/sharding/sharding-introduction-r-d-compendium.md).
